...
#define STRING_CONFIG_H_AUTHOR "dbozan99" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FF Creator X"
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 19.18f, 19.71f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.0949f, 0.0842f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.1131f, 0.1082f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {  94.52, 94.139704, 400, 96.275201870, 96.275201870 } // JS: tested X, Y, Z  
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {  94.139704, 94.139704, 400, 96.275201870, 96.275201870 } // Defaults
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {  94.139704, 94.139704, 400, 96.275201870, 96.759 } // JS todo: tested E1, not confident
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 100, 100, 20, 100, 100 } // Max XY = F6000
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 100, 5000, 5000 }
...
#define DEFAULT_EJERK    5.0  // May be used by Linear Advance // JS (was 2)
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.019636791  // (mm) Distance from real junction edge   JS: (sqrt(2)-1) * (8^2/1350)  where 8 = classic jerk and 1350 is Accel while printing
 ...
 */
#define Z_IDLE_HEIGHT 75// JS, was Z_MAX_POS but is annoying at that level as the only direction it allows is up when not homed.
...
#define X_BED_SIZE 230 // JS - Yes, these are correct.
